...
if SpecHead.nchirps< 2050
    %just process the first 1024 chirps
   SpecHead.nsegs=1;
%   SpecHead.segments=[1 513 1025];
   SpecHead.segments=[1];
end
...
for ii=1:RC.NANT
    for iii=1:SpecHead.nsegs;
        b=SpecHead.segments(iii):SpecHead.segments(iii)+SpecHead.PC.SpeclengthPnts-1;
