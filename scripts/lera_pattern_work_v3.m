...
%   
%  NOTE: the 'steering angle' as defined here (following van Trees, and in agreement with 
%    matlab signal processing is the direction a waveform is coming from.
%
...
%
%
%  01/24/2018  switched back to previous formalism for how to craft the
%              ideal pattern following Van Trees.  No good measured pattern
...
%%%%%% set array variables %%%%
phi=-179:1:180;  %this is the steering angle now 4/10/2018
disp({' i am not sure what happened to psi in this case but this code is not';
 'really different from v2 except how to treat psi'; 
 'don''t use this code right now  4/10/2018 AK '})

%%% old way .. believed to be wrong
...
%%% needed b/c of how meshgrid works, there is likely a better way to do
%%% this...someone should figure it out
...
patt.Array_bearing=[147+90]; % adjusted 4/10/2018 to figure out pattern correctly
...
disp('Note that the cable mapping changed on 7/18/2017.  Are you using the correct map?')
