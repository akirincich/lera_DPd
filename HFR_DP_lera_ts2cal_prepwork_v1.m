...
incoming_ts_file_dir=[base_dir cal_file_dir];
...
%%% from the antenna bearing. The antenna bearing is found in the radar_header
%%% and is (CW) clockwise degrees from true North. 
...
%%% .  This is correct 9/2017

% ideal_ang=patt.angles;
% % %still in true, adjust back to math
%  ideal_ang=true2math(ideal_ang);  ideal_ang=ideal_ang-true2math(patt.Array_bearing);  %adjust for T 
%  i=find(ideal_ang<-179); ideal_ang(i)=ideal_ang(i)+360;
% 
